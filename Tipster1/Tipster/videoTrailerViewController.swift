...
class videoTrailerViewController: UIViewController, WKNavigationDelegate {
    ...
    override func loadView() {
        ...
        videoTrailer = WKWebView(frame: .zero, configuration: webConfiguration)
        videoTrailer.navigationDelegate = self
        view = videoTrailer
    }
                    ...
                    if let videoError = videoError {
                        ...
                        if let firstVideo = videos.first {
                            ...
                            DispatchQueue.main.async {
                                self.videoTrailer.load(request)
                            }
                        }
                    }
                }
